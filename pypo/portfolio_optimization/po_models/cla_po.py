"""
The ``cla`` module houses the CLAPO class, which
        ...
        while True:
            ...
            if len(f) > 1:
                ...
                for i in f:
                    ...
                    if CLAPO._infnone(l) > CLAPO._infnone(l_in):
            ...
            if len(f) < self.mean.shape[0]:
                ...
                for i in b:
                    ...
                    if (self.ls[-1] is None or l < self.ls[-1]) and l > CLAPO._infnone(
                        l_out
                    ):
                        l_out, i_out = l, i
            if (l_in is None or l_in < 0) and (l_out is None or l_out < 0):
                ...
                # 4) decide lambda
                if CLAPO._infnone(l_in) > CLAPO._infnone(l_out):
                    self.ls.append(l_in)
                    f.remove(i_in)
