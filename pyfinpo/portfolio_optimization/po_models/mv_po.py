"""
The ``mv_po`` submodule houses the MeanVariancePO class, which generates
...
from ...portfolio_optimization.po_optimizers import BaseConvexOptimizer
...
class MeanVariancePO(BaseConvexOptimizer):
    ...
    def __init__(
        ...
        """
        The MeanVariancePO class (inheriting from BaseConvexOptimizer) generates an efficient frontier
        optimization object containing multiple methods (corresponding to different objective functions) 
        that can be called with various parameters.
        All optimization results are calculated within the Efficient Frontier optimization framework.
        Note: a new MeanVariancePO object should be instantiated if you want to make any change 
        to objectives/constraints/bounds/parameters. 
    ...
    def min_volatility(self):
        ...
        :rtype: OrderedDict
        """
        self._objective = po_objective_functions.portfolio_variance(
    ...
    def _max_return(self, return_value=True):
        ...
        self._objective = po_objective_functions.portfolio_return(
    ...
    def max_quadratic_utility(self, risk_aversion=1, market_neutral=False):
        ...
        if update_existing_parameter:
            ...
            self._objective = po_objective_functions.quadratic_utility(
                self._w,
    ...
    def efficient_risk(self, target_volatility, market_neutral=False):
        ...
        if update_existing_parameter:
            ...
            variance = po_objective_functions.portfolio_variance(self._w, self.cov_matrix)
    ...
    def efficient_return(self, target_return, market_neutral=False):
        ...
        if update_existing_parameter:
            ...
            ret = po_objective_functions.portfolio_return(
